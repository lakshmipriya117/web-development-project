    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="img1s.html">GALLERY</a>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">FOLLOW THE ONLINE TRENDS AND BE IN THE FASHION GAME</p>
        <a href="https://www.myntra.com/" class="btn btn-primary">CLICK HERE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">MAX FASHIONS</h5>
        <p class="card-text">BE THE ONE TO MAKE CHANGES AND BE THE TREND AMONG OTHERS.</p>
        <a href=https://www.maxfashion.in/in/en/"" class="btn btn-primary">VISIT NOW</a>
      </div>
    </div>
  </div>
</div>
