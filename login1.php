    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="over.html">WHAT TO KNOW</a>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/log.php">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">BE THE ONE IN MILLION AND ENJOY A SAFE TRAVELLING</p>
        <a href="Https://www.redbus.in/" class="btn btn-primary">CLICK HERE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">JOIN TWITTER AND BE A PART OF TODAYS CHANGE..</p>
        <a href="https://twitter.com/Twitter" class="btn btn-primary">JOIN NOW</a>
      </div>
    </div>
  </div>
</div>
